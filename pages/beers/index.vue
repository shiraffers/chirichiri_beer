          ...
          <td>
            ...
            <div class="progress progress-xs">
              <div
                ...
                role="progressbar"
                :style="{width: `${beer.alcohol}%`}"
                :aria-valuenow="beer.alcohol"
                aria-valuemin="0"
                aria-valuemax="100"
              ></div>
            </div>
    ...
    <form @submit.prevent="handleSubmit" class="beer_form">
      <div style="width: 100%;">
        <div style="text-align: center; margin-top: 20px;">
          <label style="font-size: 32px;">ビールを追加</label>
          <br />
        ...
        <div style="text-align: center; margin-top: 20px; ">
          <input
            type="submit"
            style="width: 20%; color: #F39800;border-radius: 15px;border-color: gray;"
            value="追加"
          />
        </div>
      </div>
